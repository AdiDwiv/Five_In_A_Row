...
public class Main extends JFrame {
	...
	public void setupGame() {
		...
		else if(playerXItem.equals("X: SmartAI")) {
		...
		else if (playerOItem.equals("O: DumbAI")) {
			playerO = new DumbAI(Player.O);
			game.addListener(playerO);
		}
		else if (playerOItem.equals("O: RandomAI")) {
			playerO = new RandomAI(Player.O);
			game.addListener(playerO);
		}
		else if (playerOItem.equals("O: SmartAI")){
	...
	public void setPanelThree(String result) {
		...
		panelThree.setPreferredSize(new Dimension(500, 200));
	 ...
	 * Relaunches the game
	 */
	private static void launchAgain(Main obj) {
